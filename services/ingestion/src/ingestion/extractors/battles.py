...
def fetch_and_store_games(api_key: str, oldest_time_allowed: datetime, game_modes_allowed: list, inactivity_limit_wks: int, card_to_idx: dict, log_dir: Path, soft_games_limit: int, write_player_chunk_size: int=500, read_player_chunk_size: int=5_000) -> None:
    """
